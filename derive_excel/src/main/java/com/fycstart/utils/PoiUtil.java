...
import com.fycstart.constant.ExcelConstant;
...
public class PoiUtil {
     ...
     * @throws Exception
     */
    public static final void exportExcelToLocalPath(Integer totalRowCount, String[] titles, String exportPath
     ...
     * 使用easyExcel
     */
    public static void easyExcelDerive(ExcelWriter writer, List<List<Object>> dataList) throws IOException {
   ...
   /*     List<List<String>> titles = new ArrayList<List<String>>();
     ...
     * 使用easyExcel
     */
    public static void easyExcelBeanDerive(ExcelWriter writer, List<DeptExDto> dataList) throws IOException {

        // 设置SHEET

        Sheet sheet = new Sheet(1, 0, DeptExDto.class);
   ...
   /*     List<List<String>> titles = new ArrayList<List<String>>();
    ...
    public static ExcelWriter getExcelWriter(String sheetName, HttpServletResponse httpResponse) throws IOException {
        ServletOutputStream outputStream = httpResponse.getOutputStream();
        httpResponse.setHeader("Content-disposition", "attachment; filename="
                //设置下载的文件名
                + new String((sheetName + ".xlsx")));
        //.getBytes("utf-8"), "ISO8859-1"));
        // 生成EXCEL并指定输出路径

        // OutputStream out = new FileOutputStream("E:\\temp\\withoutHead1.xlsx");

        return new ExcelWriter(outputStream, ExcelTypeEnum.XLSX);
    }
}