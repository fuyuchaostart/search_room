...
public class RentSearch {
    ...
    private String esOrderBy = "lastUpdateTime";
    private String orderDirection = "desc";

    public String getEsOrderBy() {
        return esOrderBy;
    }

    public void setEsOrderBy(String esOrderBy) {
        this.esOrderBy = esOrderBy;
    }
